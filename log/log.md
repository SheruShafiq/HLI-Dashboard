MVP: Create a Dashboard that retrieves live active user count from Google Analytics and shows them on the screen in Realtime alongside a weather widget with live weather prediction.
