...
const Weather = () => {
  ...
  const fetchData = () => {
    axios
      .get(
        "https://weerlive.nl/api/json-data-10min.php?key=3932a19976&locatie=XXX"
      )
      .then((response) => {
    ...
    <div className="container">
      <div className="weather-side">
        ...
        <div className="date-container">
          ...
          <span className="location">{users.liveweer[0].plaats}</span>
        </div>
        ...
        <div className="today-info-container">
          <div className="today-info">
            <div className="precipitation">
              ...
              <span className="value">{users.liveweer[0].d0neerslag} %</span>
              <div className="clear"></div>
            </div>
            <div className="humidity">
              {" "}
              <span className="title">HUMIDITY</span>
              <span className="value">{users.liveweer[0].lv} %</span>
              <div className="clear"></div>
            </div>
            <div className="wind">
              {" "}
              <span className="title">WIND</span>
              <span className="value">{users.liveweer[0].windkmh} km/h</span>
              <div className="clear"></div>
            </div>
          </div>
        </div>
        <div className="week-container">
          ...
          <ul className="week-list">
            <li className="active">
              ...
              <span className="day-name">{dayNameS}</span>
              <span className="day-temp">{users.liveweer[0].temp}°C</span>
            </li>
            <li>
              <i className="day-icon" data-feather="cloud"></i>
              <span className="day-name">{dayNametom}</span>
              <span className="day-temp">{users.liveweer[0].d1tmax}°C</span>
            </li>
            <li>
              <i className="day-icon" data-feather="cloud-snow"></i>
              <span className="day-name">{dayNameafttom}</span>
              <span className="day-temp">{users.liveweer[0].d2tmax}°C</span>
            </li>
            <div className="clear"></div>
          </ul>
        </div>
