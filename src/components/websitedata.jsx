...
const Websitedata = () => {
    ...
    return (
      ...
      {isShownga4>0 && ( 
		<div id="form"> <GoogleOAuthProvider clientId="328533374442-m8iju91mq7ss118pui8jj6qs1dk4tpqs.apps.googleusercontent.com"><FormGa4 /> </GoogleOAuthProvider> </div>
)}
{isShownga4>1 && ( 
		<div id="form"> <GoogleOAuthProvider clientId="328533374442-m8iju91mq7ss118pui8jj6qs1dk4tpqs.apps.googleusercontent.com"><FormGa4 /> </GoogleOAuthProvider> </div>
)}
...
{isShownga4>3 && ( 
 ...
 {isShowngua>0 && ( 
		<div id="form"> <GoogleOAuthProvider clientId="328533374442-m8iju91mq7ss118pui8jj6qs1dk4tpqs.apps.googleusercontent.com"><Form /> </GoogleOAuthProvider> </div>
)}
{isShowngua>1 && ( 
		<div id="form"> <GoogleOAuthProvider clientId="328533374442-m8iju91mq7ss118pui8jj6qs1dk4tpqs.apps.googleusercontent.com"><Form /> </GoogleOAuthProvider> </div>
)}
